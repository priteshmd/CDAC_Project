...
<body>
	...
	<%
		String gender = (String) request.getParameter("id");
	...
	<div style="width:100%"; id="b1">
		...
		<button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown">Sort By
		  ...
		  <ul class="dropdown-menu">
		    ...
		    <li><a href="genderList.jsp?id=<%=gender%>&sd=1">Price Low to High</a></li>
		    <li><a href="genderList.jsp?id=<%=gender%>&sd=2">Price High to Low</a></li>
		  </ul>
